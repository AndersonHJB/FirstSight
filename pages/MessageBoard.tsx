  ...
  useEffect(() => {
    if (containerRef.current) {
      walineInstanceRef.current = init({
        ...
        path: '/message-board',
        reaction: [
          'https://ai.bornforthis.cn/FirstSight/Waline/tieba/tieba_agree.png',
          'https://ai.bornforthis.cn/FirstSight/Waline/tieba/tieba_sunglasses.png',
          'https://ai.bornforthis.cn/FirstSight/Waline/tieba/tieba_pick_nose.png',
          'https://ai.bornforthis.cn/FirstSight/Waline/tieba/tieba_awkward.png',
          'https://ai.bornforthis.cn/FirstSight/Waline/tieba/1f613.png',
          'https://ai.bornforthis.cn/FirstSight/Waline/tieba/1f60f.png',
        ],
        comment: true,
        pageview: true,
        noCopyright: true,
